...
public class sankeFrame extends JFrame implements ActionListener {
    ...
    public sankeFrame(List<RoomInfo> roomInfoList, RoomType roomType, RoomInfo roomInfo, Pwd pwd) {
        ...
        roomCodeJLabel = createJLabelOfCenter(roomCodeJLabel, "主客房间:" + roomInfo.getId(), 10, 40, 190, 25);
        ...
        guestCount.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void validate() {
                try {
                    int value = Integer.parseInt(guestCount.getText());
                    if (value < 1) {
                        JOptionPane.showMessageDialog(null, "人数不能小于1");
                        guestCount.setText("1");
                    } else {
                        livein.setRenshu(value);
                    }
        ...
        livein.setAddress("");
        String addressInfoText = addressInfo.getText();
        ...
        livein.setRemark("");
        String setRemarkText = otherInfo.getText();
        ...
        Double accountText = Double.valueOf(actualPrice.getText());

        livein.setAccount(accountText);
        ...
        livein.setDays(1);
        Integer daysText = Integer.valueOf(useRoomDays.getText());

        livein.setDays(daysText);
        ...
        Double foregiftText = Double.valueOf(cashPledge.getText());
        livein.setForegift(foregiftText);
